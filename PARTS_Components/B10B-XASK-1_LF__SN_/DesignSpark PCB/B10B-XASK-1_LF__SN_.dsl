...
(library Library_1
	...
	(patternDef "SHDR10W64P0X250_1X10_2740X575X" (originalName "SHDR10W64P0X250_1X10_2740X575X")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.45 3.4) (pt 24.95 3.4) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 24.95 3.4) (pt 24.95 -2.35) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 24.95 -2.35) (pt -2.45 -2.35) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "B10B-XASK-1_LF__SN_" (originalName "B10B-XASK-1_LF__SN_") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		...
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/dk/DKDS41/DSANUWW0025348.pdf")
		(attr "Height" "7 mm")
	)
